this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    var Za = "IN_PROGRESS", es = "WIN", as = "FAIL",
        ss = ["Genius", "Magnificent", "Impressive", "Splendid", "Great", "Phew"], ts = function (e) {
            r(t, e);
            var a = h(t);
            ...
            return o(t, [{
                ...
                key: "connectedCallback", value: function () {
                    ...
                    this.$game.addEventListener("game-key-press", (function (a) {
                        ...
                        var s = e.$game.querySelector("game-page"), t = document.createTextNode("Settings");
                        s.appendChild(t);
...
`;
  ...
  \t\t <button id="refresh-button">Play again!<game-icon icon="refresh">></game-icon>
  \t  </div>
  \t</div>
    </div>
  </div>
  <div class="share">
    ...
    <button id="share-button"> Share <game-icon icon="share"></game-icon>
    </button>
